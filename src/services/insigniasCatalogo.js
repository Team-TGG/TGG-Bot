...
//
// `en` traz nome e descrição para quem recebe o bot em inglês (cargos EU e NA, ver src/i18n/index.js).
// Mudou o nome em português, confira o inglês na mesma entrada; faltando, a checagem avisa.
//
...
// O valor é a identidade da categoria em `categoria` e também o nome em português; o inglês está em
// i18n/en/perfil.js.
...
export const INSIGNIAS = [
  ...
  },
  {
    ...
    en: { nome: 'Duelist', descricao: 'Ranked 1v1 wins in your best season' },
  ...
  },
  {
    ...
    en: { nome: 'Specialist', descricao: 'Hours with your most-used weapon, across every legend that uses it' },
  ...
  },
  {
    ...
    en: { nome: 'Veteran', descricao: 'Level of your highest-level account' },
  ...
  },
  {
    ...
    en: { nome: 'Master', descricao: 'Level of your highest-level legend' },
  ...
  },
  {
    ...
    en: { nome: 'Welcome', descricao: 'Be in the in-game guild' },
  ...
  },
  {
    ...
    en: { nome: 'Linked', descricao: 'Alternate accounts linked to yours' },
  ...
  },
  {
    ...
    en: { nome: 'Curious', descricao: 'Use .help' },
    tiers: null, acumulacao: 'recorde',
  ...
  },
  {
    ...
    en: { nome: 'Explorer', descricao: 'Visit the TGG website' },
    tiers: null, acumulacao: 'recorde',
  ...
  },
  {
    ...
    en: { nome: 'Birthday', descricao: 'Register your birthday with .birthday' },
  ...
  },
  {
    ...
    en: { nome: 'Completionist', descricao: 'Max out every other badge (Clean Record does not count)' },
  ...
  },
  {
    ...
    en: { nome: 'Collector', descricao: 'Weekly achievement tiers completed (each tier counts as one)' },
  ...
  },
  {
    ...
    en: { nome: 'VIP', descricao: 'Buy VIP in the shop' },
    tiers: null, acumulacao: 'atual',
    medir: (c) => c.economia.comprouVip,
  },
];

/** Nome e descrição no idioma pedido; sem tradução na entrada, o português. */
export function textoDaInsignia(insignia, idioma) {
  return {
    nome: insignia[idioma]?.nome ?? insignia.nome,
    descricao: insignia[idioma]?.descricao ?? insignia.descricao,
  };
}
